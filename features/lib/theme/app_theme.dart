...
class AppTheme {
  ...
  static final ThemeData lightTheme = ThemeData(
    ...
    textTheme: TextTheme(
        headlineMedium: GoogleFonts.aBeeZee(), bodyMedium: GoogleFonts.abel()),

    /// Colorscheme
    colorScheme: ColorScheme.light(
        primary: Color(0xff3C4EC5),
        onPrimary: Color(0xffeeeeee),
        onPrimaryFixedVariant : Color(0xff3C4EC5),
        secondary: Color(0xff3C4EC5),
        onSecondaryFixedVariant: Color(0xffeeeeee),
  ...
  static final ThemeData darkTheme = ThemeData(
    ...
    colorScheme: ColorScheme.dark(
      ...
      onPrimaryFixedVariant: Color(0xff069DEF),
